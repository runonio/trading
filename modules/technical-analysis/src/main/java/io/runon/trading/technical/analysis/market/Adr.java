...
public class Adr extends MarketIndicator<TimeNumber>{
    ...
    public static final BigDecimal MAX = new BigDecimal(Config.getConfig("adr.max", "500"));
    ...
    public TimeNumber getData(int index) {
        ...
        BigDecimal adr = new BigDecimal(upCount).divide(new BigDecimal(downCount), MathContext.DECIMAL128);
        data.setNumber(adr.multiply(BigDecimals.DECIMAL_100).setScale(scale, RoundingMode.HALF_UP));
