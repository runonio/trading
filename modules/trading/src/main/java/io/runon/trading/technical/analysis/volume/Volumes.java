...
public class Volumes {
    ...
    public static TimeNumber[] smaDisparity(TradeCandle[] array, int shortN, int longN){
        return smaDisparity(array, shortN, longN, 0, array.length);
    }

    public static TimeNumber [] smaDisparity(TradeCandle[] array, int shortN, int longN, int beginIndex, int end){
        if(beginIndex < 0){
            beginIndex = 0;
        }
