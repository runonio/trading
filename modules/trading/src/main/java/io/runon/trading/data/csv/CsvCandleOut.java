 ...
 * @author macle
 */
public  class CsvCandleOut {


    /**
     * 파일에 새로운 내용을 추가한다.
     */
    public static void outNewLines(String [] lines, String filesDirPath, TimeName.Type type, ZoneId zoneId){
     ...
     */
    public static void outBackPartChange(String [] lines, String filesDirPath, TimeName.Type type, ZoneId zoneId){
        if(lines.length == 0){
            return;
        }
        ...
        long openTime = CsvTimeFile.getTime(firstLine);
        String fileSeparator = FileSystems.getDefault().getSeparator();
